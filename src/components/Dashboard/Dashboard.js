  ...
  return (
    <div className='dashboard--wrapper'>
                                ...
                                displayedRecentExpenses.map(elem => 
                                    <tr key={elem.invoiceId} className='recent--tbodyRow'>
                                        ...
                                        <td className='recent--tbodyData recent--description'>
                                            <div className='recent--descriptionText'>{elem.description}</div>
        ...
        <div className="dashboard--recurringExpenses">
            ...
            <div>
                {props.recurringExpenses.map(elem => (
                    <div className='recurring--expense' key={elem.id}>
                        <div className='recurring--expenseDescriptionContainer'>
                            <div className="recurring--icon">
                                <img src={elem.icon} alt={elem.description} width="40px" height="40px" />
                            </div>
                            <div className="recurring--description">
                                <div className="recurring--descriptionText">{elem.description}</div>
                                <div className="recurring--descriptionSeller">{elem.seller}</div>
                            </div>
                        </div>
